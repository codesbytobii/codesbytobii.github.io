...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "var(--bg-2)", borderTop: "1px solid var(--border)" }}>
      ...
      <div className="container footer-container" style={{ padding: "64px 5vw 40px", width: "100%", maxWidth: "100%", overflowX: "hidden" }}>
        <div className="footer-grid">
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              {navLinks.map(link => (
                <Link key={link.label} to={link.href} style={{ color: "var(--text-mid)", fontSize: "14px", transition: "color 0.2s", width: "fit-content" }}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              {[
                ...
                <div key={item.label}>
                  ...
                  <span style={{ color: "var(--text-mid)", fontSize: "13px", wordBreak: "break-word" }}>{item.value}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Bottom bar */}
        <div className="footer-bottom-bar" style={{ borderTop: "1px solid var(--border)", paddingTop: "24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
